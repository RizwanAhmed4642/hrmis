...
public partial class VpGeoView
{
    ...
    public Nullable<double> DivisionLatitude { get; set; }

    public Nullable<double> DivisionLongitude { get; set; }

    public Nullable<double> DistrictLatitude { get; set; }

    public Nullable<double> DistrictLongitude { get; set; }

    public Nullable<double> TehsilLatitude { get; set; }

    public Nullable<double> TehsilLongitude { get; set; }

    public string HFName { get; set; }

    public Nullable<double> HFLatitude { get; set; }

    public Nullable<double> HFLongitude { get; set; }
