...
public partial class ProfileDetailsSeniorityView
{
    ...
    public Nullable<int> SenorityId { get; set; }

    public Nullable<System.DateTime> SenorityDateOfAppointment { get; set; }

    public Nullable<System.DateTime> SenorityDateOfBirth { get; set; }

    public Nullable<int> SenorityDesignation_Id { get; set; }

    public string SenorityDomicile { get; set; }

    public string SenorityFatherName { get; set; }

    public string SenorityGrievance { get; set; }

    public string SenorityName { get; set; }

    public string SenorityPlaceOfPosting { get; set; }

    public Nullable<int> SenorityPPSCMerit { get; set; }

    public Nullable<int> SeniorityMaster_Id { get; set; }

    public string SenioritySeniorityNo { get; set; }

    public string SenioritySeniorityNoOld { get; set; }

    public string SeniorityStatus { get; set; }

    public string SenioritySupportingDocs { get; set; }

    public Nullable<int> SeniorityYearOfJoining { get; set; }
