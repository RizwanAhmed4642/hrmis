...
export class CauseListComponent implements OnInit, OnDestroy {
  ...
  public getCauseList() {
    ...
    this._fileTrackingSystemService.getCauseList({
  ...
  public removeCauseList(dataItem: any) {
    dataItem.removing = true;
    if (confirm('Are you sure you want to remove?')) {
      this._fileTrackingSystemService.removeCauseList(dataItem.Id).subscribe((res: any) => {
        if (res) {
          this.getCauseList();
