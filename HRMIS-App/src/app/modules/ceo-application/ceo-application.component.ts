...
@Component({
  selector: 'app-ceo-application',
  templateUrl: './ceo-application.component.html',
  styles: []
})
export class CEOApplicationComponent implements OnInit {
  ...
  constructor(private sanitizer: DomSanitizer,
    ...
    private _riService: CEOApplicationService,
  ...
  public removeApplication(application) {
    if (confirm('Remove Tracking # ' + application.TrackingNumber + '?')) {
      ...
      this._riService.removeApplication(application.Id, application.TrackingNumber, applicationLog).subscribe((res: any) => {
        if (res) {
