...
@Component({
  selector: 'app-compassionate',
  templateUrl: './compassionate.component.html',
  styles: []
})
export class CompassionateComponent implements OnInit {
  ...
  public applicationSubType_Id: number = 3;
