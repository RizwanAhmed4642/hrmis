...
@Component({
  selector: "app-adhoc-interviews",
  templateUrl: "./adhoc-interviews.component.html",
  styleUrls: ['./adhoc-interviews.component.scss']
})
export class AdhocInterviewsComponent implements OnInit, OnDestroy {
  ...
  public getAdhocInterviews = () => {
    ...
    this._adhocService.getAdhocJobInterviews(obj).subscribe((res: any) => {
      if (res) {
