...
@Component({
  selector: "app-adhoc-application-scrutiny",
  templateUrl: "./adhoc-application-scrutiny.component.html",
  styleUrls: ['./adhoc-application-scrutiny.component.scss']
})
export class AdhocApplicationScrutinyComponent implements OnInit, OnDestroy {
    ...
    this.subscription = this.route.params.subscribe(
      (params: any) => {
        ...
        if (params.hasOwnProperty('statusId')) {
          this.filters.Status_Id = +params['statusId'];
        }
