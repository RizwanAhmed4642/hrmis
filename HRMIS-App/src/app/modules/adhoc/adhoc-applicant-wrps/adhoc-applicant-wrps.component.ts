...
@Component({
  selector: "app-adhoc-applicant-wrps",
  templateUrl: "./adhoc-applicant-wrps.component.html",
  styleUrls: ['./adhoc-applicant-wrps.component.scss']
})
export class AdhocApplicantWRPSComponent implements OnInit, OnDestroy {
    ...
    if (item) {
      ...
      this._adhocService.getAdhocInterviewBatchApplications(this.interviewBatch.Id).subscribe((applications: any[]) => {
        if (applications && applications.length > 0) {
          ...
          this.count = 0;
          this.interviewBatch.Applications.forEach(app => {
