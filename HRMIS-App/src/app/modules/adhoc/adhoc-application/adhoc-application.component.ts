...
@Component({
  selector: "app-adhoc-application",
  templateUrl: "./adhoc-application.component.html",
  styleUrls: ['./adhoc-application.component.scss']
})
export class AdhocApplicationComponent implements OnInit, OnDestroy {
