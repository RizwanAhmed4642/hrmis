...
@Injectable({
  ...
  public getNewSeniorityList(filters: any) {
    return this.http.post(
      `${Config.getControllerUrl("Profile", "GetNewSeniorityList")}`, filters
    );
  }
  public verifyProfileForPromotion(profileId: number) {
    return this.http.get(
      `${Config.getControllerUrl("Profile", "VerifyProfileForPromotion")}/${profileId}`);
  }
  public getSeniorityApplicant(cnic: string) {
    return this.http.get(
      `${Config.getControllerUrl("Profile", "GetSeniorityApplicant")}/${cnic}`);
  }
  public changeSeniorityApplicationStatus(id: number, statusId: number) {
    return this.http.get(
      `${Config.getControllerUrl("Profile", "ChangeSeniorityApplicationStatus")}/${id}/${statusId}`);
  }
