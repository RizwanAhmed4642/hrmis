...
import { OnlinePromotionApplyService } from '../../../portal/online-promotion-apply/online-promotion-apply.service';
...
export class ProfileComponent implements OnInit, OnDestroy {
    ...
    this.subscription = this.route.params.subscribe(
      (params: any) => {
        if (params.hasOwnProperty('cnic')) {
          this.applicant.CNIC = params['cnic'];
          this.getApplicant();
        }
      }
    );
  ...
  public checkValidations() {
    ...
    if (this.applicant.ModeId == 1) {
      if (this.applicant.LastPromotionDate && this.applicant.PromotionOrderNumber && this.applicant.PromotionJoiningDate) {
        this.validations.masterFlag = true;
      } else {
        this.validations.masterFlag = false;
      }
    } else if (this.applicant.ModeId == 2) {
      if (this.applicant.RegularOrderNumber && this.applicant.DateOfRegularization && this.applicant.FirstJoiningDate && this.applicant.PPSCMeritNumber) {
        this.validations.masterFlag = true;
      } else {
        this.validations.masterFlag = false;
      }
    } else if (this.applicant.ModeId == 3) {
      if (this.applicant.ContractOrderNumber && this.applicant.ContractStartDate && this.applicant.ContractOrderDate
      ...
      if (this.applicant.RegularOrderNumber && this.applicant.DateOfRegularization && this.applicant.FirstJoiningDate) {
        this.validations.masterFlag = true;
      } else {
        this.validations.masterFlag = false;
      }
