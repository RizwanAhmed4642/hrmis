...
@Component({
  selector: 'app-hrmis-ri-branchdashboard',
  templateUrl: './ri-branch.component.html',
  styleUrls: ['./ri-branch.component.scss']
})
export class RiBranchComponent implements OnInit {
  ...
  public getRiBranchReportTypeWiseDate() {
    this.loading = true;
    this._dashboardService.getRiBranchReportTypeWiseDate(null, null, this.userId).subscribe((data: any) => {
