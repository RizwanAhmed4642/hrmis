...
@Component({
  selector: 'app-dailywager-count',
  templateUrl: './dailywager-count.component.html',
  styleUrls: ['./dailywager-count.component.scss']
})
export class DailywagerCountComponent implements OnInit {
    ...
    public selectedFiltersModel: any = {
      ...
      designations : { Name: 'Select Designation', Code: '0'}
    };
  ...
  'Wheel Chair/Strature',
    ...
    public loadProfiles() {
      ...
      this.loading = true;
      if (this.isPool) {
        this._DailyWagerService.GetDailyWagesCount(this.skip, this.pageSize, this.hfmisCode, this.divisionCode, this.designations, this.districtCode, this.tehsilCode).subscribe(
        ...
        debugger
        this._DailyWagerService.GetDailyWagesCountProfile(this.skip, this.pageSize, this.hfmisCode, this.searchTerm, this.selectedCadres, this.selectedDesignations, this.selectedStatuses, this.retirementInOneYear, this.retirementAlerted, this.designationStr).subscribe(
          response => this.handleResponse(response),
          err => this.handleError(err)
        );
      }
    ...
    public dropdownValueChanged = (value, filter) => {
      ...
      if (filter == 'designations') {
        this.designations = null;
        this.designations = value.Code;
        this.selectedFiltersModel.designations.Code = this.hfmisCode;
        this.resetDrops(filter);
        this.getHealthFacilities();
        this.getUCs();
      }
