...
export class JobsListComponent implements OnInit {
  ...
  constructor(private datePipe: DatePipe, private router: Router, private _cookieService: CookieService, 
  ...
  public getAdhocVacants() {
    this.jobVacancy = {};
    this._onlineAdmissionsService.getAdhocVacants('facilities', this.desigId).subscribe((res: any) => {
      if (res) {
        this.jobVacancy = res;
  ...
  public getAdhocs() {
    ...
    this._onlineAdmissionsService.getAdhocs(this.selectedCategoryId).subscribe((res: any) => {
      if (res) {
