...
export class ReviewComponent implements OnInit {
  ...
  public getJobApplications() {
    this._onlineAdmissionsService.getJobApplications(this.applicant.Id, this.hfmisCode).subscribe((res: any) => {
      if (res) {
  ...
  public getPreferences() {
    ...
    this._onlineAdmissionsService.getPreferences(this.merit.Id).subscribe((response: any) => {
      if (response) {
  ...
  getOfferLetterLink() {
    ...
    this._onlineAdmissionsService.getDownloadLinkById(this.merit.Id).subscribe((link) => {
