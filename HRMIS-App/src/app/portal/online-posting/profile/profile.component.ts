...
export class ProfileComponent implements OnInit {
  ...
  public onSubmit() {
    ...
    /* this.merit.MeritsActiveDesignationId = 36;
    this.merit.Status = 'New'; */
    /*  this.merit.MeritsActiveDesignationId = 1320; */
        ...
        if (this.photoFile.length > 0) {
          this._onlinePostingService.uploadMeritProfilePhoto(this.photoFile, res.CNIC).subscribe((res: any) => {
            if (res) {
              ...
              this.router.navigate(['/ppsc/preferences']);
            }
          }, err => {
