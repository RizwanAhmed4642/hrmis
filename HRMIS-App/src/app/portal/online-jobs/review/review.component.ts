...
export class ReviewComponent implements OnInit {
  ...
  public getJobApplications() {
    this._onlineJobsService.getJobApplications(this.applicant.Id, this.hfmisCode).subscribe((res: any) => {
      if (res) {
  ...
  public getPreferences() {
    ...
    this._onlineJobsService.getPreferences(this.merit.Id).subscribe((response: any) => {
      if (response) {
  ...
  getOfferLetterLink() {
    ...
    this._onlineJobsService.getDownloadLinkById(this.merit.Id).subscribe((link) => {
